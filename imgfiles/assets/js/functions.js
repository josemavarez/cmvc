function checkPlan() {
    // Get the checkbox
    var checkBox = document.getElementById("js-plan");
    // Get the output text
    var planMonth = document.getElementsByClassName("js-text-month");
    var planYear = document.getElementsByClassName("js-text-year");
    ...
    if (checkBox.checked == true){+
        ...
        for (var i=0;i<planMonth.length;i+=1){
            planMonth[i].style.display = 'none';
          }
        for (var i=0;i<planYear.length;i+=1){
            planYear[i].style.display = 'block';
          }
        
    } else {
        console.log('to month');
        for (var i=0;i<planMonth.length;i+=1){
            planMonth[i].style.display = 'block';
          }
        for (var i=0;i<planYear.length;i+=1){
            planYear[i].style.display = 'none';
          }
...
const setActiveItem = () => {
    ...
    // const path = "crm";
    const  navbarItem = document.getElementsByClassName("js-navbar--option");
    console.log(navbarItem);
  
    for (let i = 0; i <  navbarItem.length; i++) {
      if ( navbarItem[i].getAttribute("navbar-item-title")) {
        if ( navbarItem[i].getAttribute("navbar-item-title") == path) {
...
// let addFixed = document.getElementById('navbar-toggler');
// let removeFixed = document.getElementById('remove-fixed-body');
...
var e = {
    ...
    stickyHeader: function () {
        ...
        var otherNavElement = document.querySelectorAll('.js-other-nav');
        console.log(otherNavElement);
            ...
            if (e.isVariableDefined(stickySpace)) {
                document.addEventListener('scroll', function (event) {
                    ...
                    if (scTop >= 400) {
                        ...
                        // otherNavElement.forEach(e => e.style.display = "block");
                        ...
                        // otherNavElement.forEach(e => e.style.display = "none");
                    }
                });
            }
        }
