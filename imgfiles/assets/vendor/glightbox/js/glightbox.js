(function (global, factory) {
  ...
  function slideVideo(slide, data, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      var nextVideo = document.querySelector('.gnext');
      var prevtVideo = document.querySelector('.gprev');
      nextVideo.addEventListener("click", pauseFunction);
      prevtVideo.addEventListener("click", pauseFunction);
